    ...
    <body id="body-pd">
        <header class="header" id="header">
            ...
            <div class="container-fluid mt-5">
                <div class="d-flex justify-content-center">
                    <span class="fs-1 mt-5 border-bottom border-2 mb-3">Notificaciones</span>
                </div>
            </div>
            <div class="height-100">
                <div class="container-fluid">
                    <span class="d-flex justify-content-center fs-3 mb-3 mt-5">
                        ...
                        <table class="table table-hover table-striped">
                            ...
                            <c:forEach var="n" items="${notifications}">
                                <tr>
                                    ...
                                    <td>${n.cod_emp}</td>
                                    <td>${n.nombre_user}</td>    
                                    <td>${n.apellido_user}</td> 
                                    <td>${n.fecha_envio}</td>
                                    <td class="text-center">
                                        <input type="hidden" id="User" value="${n.usuario}">
                                        <a href="#" class="btn btn-success me-3" id="btnAceptar">Aceptar<i class="fas fa-check ms-1"></i></a>
                                        <a href="#" class="btn btn-danger" id="btnRechazar">Rechazar<i class="fas fa-times ms-1"></i></a>
                                    </td>                                        
                                </tr>
                            </c:forEach>
                        </tbody>
        ...
        <script>
            $(document).ready(function () {
                    ...
                    swalWithBootstrapButtons.fire({
                        ...
                        if (result.isConfirmed) {
                            swalWithBootstrapButtons.fire(
                                ...
                                if (result) {
                                    parent.location.href = "notificacionesController?action=home";
                                }
                            });
                            accept(user);
                        } else if (
                ...
                function accept(us) {
                    var url = 'notificacionesController?action=interaction&interaction=accept';
                    $.ajax({
                        type: 'POST',
                        url: url,
                        data: 'user=' + us,
        ...
        <script>
            $(document).ready(function () {
                ...
                function accept(us) {
                    var url = 'notificacionesController?action=interaction&interaction=decline';
                    $.ajax({
                        type: 'POST',
                        url: url,
                        data: 'user=' + us,
