        ...
        <header class="header" id="header">
            ...
            <div class="container-fluid mt-5">
                <div class="d-flex justify-content-center">
                    <span class="fs-1 mt-5 border-bottom border-2 mb-3">Modificar Directorio de Allied Global</span>
                </div>
                <div class="container-fluid p-5 mb-5">
                    <form action="alliedController?action=update" method="post">
                    <c:forEach var="c" items="${moAllied}">
                        <div class="row g-xl-2">
                            <div class="col-xl-4">
                                <div class="form-floating mb-3">
                                    <input type="hidden" value="${c.id}" name="id">
                                    <input type="text" class="form-control" id="floatingInput" value="${c.skill}" name="skill">
                                    <label for="floatingInput">Nueva Skill</label>
                                </div>
                            </div>
                            <div class="col-xl-4">
                                <div class="form-floating mb-3">
