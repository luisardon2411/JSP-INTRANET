    ...
    <body id="body-pd">
        ...
        <div class="l-navbar" id="nav-bar">
                <nav class="nav fw-bold">
                    ...
                    <a href="loginController?action=logout" class="nav_link"> <i class='bx bx-log-out nav_icon icon_hov'></i> <span class="nav_name">Cerrar Sesión</span> </a>
                </nav>
        </div>
