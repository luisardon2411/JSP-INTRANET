        ...
        <header class="header" id="header">
            ...
            <div class="container-fluid mt-5">
                <div class="d-flex justify-content-center">
                    <span class="fs-1 mt-5 border-bottom border-2 mb-3">Modificar Externo</span>
                </div>
                <div class="container m-3 p-0 text-center">
                    <div class="alert alert-warning" role="alert">
                        ...
                        IMPORTANTE: Para modificar un externo se tiene que saber el codigo del distribuidor y el país del cual se va a modificar.
                    </div>
                </div>
                <div class="container-fluid p-5">
                    <form action="externosController?action=update" method="post">
                    <c:forEach var="c" items="${Extern}">
                        <div class="row g-xl-2">
                            <div class="col-xl-4">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="floatingInput" value="${c.cod_emp}" disabled>
                                    <input type="hidden" value="${c.idexterno}" name="idexterno">
                        ...
                        <div class="row g-xl-2">
                            <div class="col-xl-6">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="floatingInput" name="codEmp" required="">
                                    <label for="floatingInput">Nuevo Codigo de Distribuidor</label>
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="form-floating">
