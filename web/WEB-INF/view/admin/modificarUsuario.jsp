    ...
    <body id="body-pd">
        ...
        <div class="container-fluid mt-5">
            <div class="d-flex justify-content-center">
                <span class="fs-1 mt-5 border-bottom border-2 mb-3">Modificar Usuario</span>
            </div>
            <div class="container-fluid p-5">
                <form action="usuarioController?action=update" method="post">
                <c:forEach var="c" items="${modify}">
                    <div class="row g-xl-2">
                        <div class="col-xl-3">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingInput" value="${c.usuario}"  name="user" disabled>
                        ...
                        <div class="col-xl-3">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingInput" value="${c.nombre_user}" disabled>
                                <label for="floatingInput">Nombre</label>
                            </div>
                        </div>
                        <div class="col-xl-3">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingInput" value="${c.apellido_user}" disabled>
                    ...
                    <div class="row g-xl-2">
                        <div class="col-xl-6">
                            <div class="form-floating mb-3">
                                <select class="form-select" id="floatingSelect" aria-label="Floating label select example" name="tipoU" required="">
