    ...
    <body id="body-pd">
        ...
        <div class="container-fluid mt-5">
            <div class="d-flex justify-content-center">
                <span class="fs-1 mt-5 border-bottom border-2 mb-3">Modificar Jefe</span>
            </div>
            <div class="container-fluid p-5">
                <form action="jefesController?action=update" method="post">
                <c:forEach var="c" items="${J}">
                    <div class="row g-xl-2">
                        <div class="col-xl-6">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingInput" value="${c.cod_emp}" disabled>
                                <input type="hidden" value="${c.idJefes}" name="idjefe">
