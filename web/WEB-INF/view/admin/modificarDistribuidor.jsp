        ...
        <header class="header" id="header">
            ...
            <div class="container-fluid mt-5">
                <div class="d-flex justify-content-center">
                    <span class="fs-1 mt-5 border-bottom border-2 mb-3">Modificar Distribuidor</span>
                </div>
                <div class="container-fluid p-5 mb-5">
                    <form action="representantesController?action=update" method="post">
                    <c:forEach var="c" items="${repre}">
                        <div class="row g-xl-2">
                            <div class="col-xl-4">
                                <div class="form-floating mb-3">
                                    <input type="hidden" value="${c.idDistribuidor}" name="idDistribuidor">
                                    <input type="text" class="form-control" id="floatingInput" placeholder="name@example.com" value="${c.codDist}" disabled>
                                    <label for="floatingInput">Codigo Distribuidor</label>
                                </div>
                            </div>
                            <div class="col-xl-4">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="floatingInput" placeholder="name@example.com" value="${c.nombreDistribuidor}" disabled>
                                    <label for="floatingInput">Nombre Distribuidor</label>
                                </div>
                            </div>
                            <div class="col-xl-4">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="floatingInput" placeholder="name@example.com" name="encargado" value="${c.encargado}">
                                    <label for="floatingInput">Nuevo Encargado</label>
                                </div>
                            </div>
                        </div>
                        <div class="row g-xl-2">
                            <div class="col-xl-6">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="floatingInput" placeholder="name@example.com" name="email" value="${c.email}">
                                    <label for="floatingInput">Nuevo Correo Electronico</label>
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="floatingInput" placeholder="name@example.com" value="${c.pais}" disabled>
