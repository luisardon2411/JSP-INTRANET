    ...
    <body id="body-pd">
        <header class="header" id="header">
            ...
            <div class="container-fluid p-5 text-center">
                <div class="d-flex justify-content-center">
                    <h3 class="fs-1 mt-5 border-bottom border-2 mb-3">Internos</h3>
                </div>
                <div class="container-fluid text-center">
                    ...
                    <div class="alert alert-danger d-flex align-items-center" role="alert" id="alert">
                        ...
                        <div>
                            El codigo del jefe no existe, intente nuevamente.
                        </div>
                    </div>
                </div>
                <div class="d-flex justify-content-start">
                    ...
                    <button type="button" class="btn me-2 text-light" data-bs-toggle="modal" data-bs-target="#staticBackdrop" style="background-color:rgb(185, 17, 0); ">
                        Nuevo Interno<i class="fas fa-plus ms-1"></i>
                    </button>  
                    <!-- Modal -->
                        ...
                        <div class="modal-dialog modal-dialog-scrollable">
                            <div class="modal-content">
                                <div class="modal-header text-light" style="background-color: rgb(185, 17, 0) !important;">
                                    <h5 class="modal-title" id="staticBackdropLabel">Agregar Interno</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <div class="container-fluid">
                                        <form action="internosController?action=insert" method="post" class="font needs-validation"  novalidate>
                                            <div class="container m-0 p-0 mb-3">
                                                <div class="alert alert-warning" role="alert">
                                                    <figure class="d-flex justify-content-center">
                                                        <img src="image/warning.gif" width="40" height="40" class="me-2 text-center"/>
                                                    </figure>
                                                    IMPORTANTE: Antes de registrar un interno tiene que existir el jefe del mismo.

                                                </div>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control" id="floatingInput" placeholder="name@example.com" name="cod_emp" required="">
                                                <label for="floatingInput">Codigo de empleado</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control" id="floatingInput" placeholder="name@example.com" name="nombre_emp" required="">
                                                <label for="floatingInput">Nombre</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control" id="floatingInput" placeholder="name@example.com" name="apellido_emp" required="">
                                                <label for="floatingInput">Apellido</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input type="date" class="form-control" id="floatingInput" placeholder="name@example.com" name="fecha_nac" required="">
                                            ...
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control" id="floatingInput" placeholder="name@example.com" name="sede">
                                            ...
                                            <div class="row">
                                                <div class="col-xl-6">
                                                    <div class="form-floating mb-3">
                                                        <input type="text" class="form-control" id="floatingInput" placeholder="name@example.com" name="codJefe" required="">
                                                        <label for="floatingInput">Codigo Jefe</label>
                                                    </div>
                                                </div>
                                                <div class="col-xl-6">
        ...
        <div class="height-100">
            <div class="d-flex justify-content-center text-center">
                <span class="fs-2 font">Internos Registrados</span>
            </div>
            <div class="container-fluid m-0  p-0">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-striped mt-1" id="myTable">
                        ...
                        <tbody class="fs-6">
                            <c:forEach var="c" items="${internos}">
                                <tr>
                                    <td>${c.cod_emp}</td>
                                    <td>${c.nombre_emp}</td>                                  
                                    ...
                                    <td>${c.estado}</td>
                                    <td>${c.pais}</td>
                                    <td class="text-center"><a href="internosController?action=modify&idInterno=${c.idinternos}" class="btn btn-success me-1"><i class="fas fa-pen"></i></a></td>
                                </tr>                                
                            </c:forEach>
