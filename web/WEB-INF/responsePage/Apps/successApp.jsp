        ...
        <header class="header" id="header">
            ...
            <div class="container-fluid p-5">
                <div class="d-flex justify-content-center">
                    <span class="fs-1 mt-5 border-bottom border-2 mb-3">Aplicaciones Adicionales</span>
                </div>
                    ...
                    <div class="alert alert-success d-flex align-items-center justify-content-center" role="alert" id="alert">
                        ...
                        <div class="text-center">
                            Aplicacion registrada con exito
                        </div>
                    </div>
                </div>
                <div class="d-flex justify-content-start">
                    ...
                    <button type="button" class="btn me-2 text-light" data-bs-toggle="modal" data-bs-target="#staticBackdrop" style="background-color:rgb(185, 17, 0); ">
                        Nueva Aplicacion<i class="fas fa-plus ms-1"></i>
                    </button>  
                    <!-- Modal -->
                        ...
                        <div class="modal-dialog modal-dialog-scrollable">
                            <div class="modal-content">
                                <div class="modal-header text-light" style="background-color: rgb(185, 17, 0) !important;">
                                    <h5 class="modal-title" id="staticBackdropLabel">Agregar Aplicacion</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <div class="container-fluid">
                                        <form action="contactoController?action=insert" method="post" class="font needs-validation"  novalidate>
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control" id="floatingInput" placeholder="name@example.com" name="app" required="">
                                                <label for="floatingInput">Nombre Aplicacion</label>
                                            </div>
                                            <div class="form-floating mb-3">
            ...
            <div class="height-100">
                <div class="d-flex justify-content-center text-center">
                    <span class="fs-2 font">Aplicaciones Registradas</span>
                </div>
                <div class="container-fluid m-0  p-0">
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover table-striped mt-1" id="myTable">
                            ...
                            <tbody class="fs-6">
                            <c:forEach var="c" items="${aplicaciones}">
                                <tr>
                                    <td>${c.aplicacion}</td>
                                    <td>${c.encargado}</td>                                  
                                    <td>${c.correo}</td>
                                    <td class="text-center"><a href="contactoController?action=modify&id=${c.id}" class="btn btn-success me-1"><i class="fas fa-pen"></i></a></td>
                                </tr>                                
                            </c:forEach>
                        </tbody>
                    </table>
